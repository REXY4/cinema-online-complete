...
function AddFilm(){
    ...
    let match = useRouteMatch("/detailfilm/:id");
    ...
    const loadFilm = async (id) => {
        ...
        try {
            const response = await API.get(`/film/${match.params.id}`);
    ...
    const handleSubmit = async () => {
        try {
            ...
            const response = await API.patch(`/film/${match.params.id}`, formData, config);
        ...
        <Container className="container-add mt-3">
            ...
            <Form onSubmit={(e)=>{
                ...
                <Row>
                    ...
                    <Form.Control placeholder={film?.title}
                    className="addTitle"
                    name="title"
                    value={form.title}
            ...
            <div>
               ...
               >Attach Payment <img src="/img/payment.svg"
                ...
                <Form.Group controlId="exampleForm">
                            ...
                            <Form.Control type="text" className="exampleForm"custom 
                             name="category"
                             value={form.category}
                             onChange={(e) => onChange(e)}>
